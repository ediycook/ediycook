...
This application is configured for Service Discovery and Configuration with the JHipster-Registry. On launch, it will refuse to start if it is not able to connect to the JHipster-Registry at [http://192.168.99.100:8761](http://192.168.99.100:8761). For more information, read our documentation on [Service Discovery and Configuration with the JHipster-Registry][].
...
To optimize the edkgtw application for production, run:
